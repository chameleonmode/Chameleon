...
namespace Chameleon.app.Avalonia.Com.Avalonia.Converters.ValueConverters;
...
public class SvgNameToDataConverter : IValueConverter {
	public object? Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
	{
		...
		if (Application.Current?.TryGetResource("AccentFillColorDefaultBrush", Application.Current.ActualThemeVariant, out var accentbrush) == true &&
				Application.Current.TryGetResource("ControlStrokeColorOnAccentDefaultBrush", Application.Current.ActualThemeVariant, out var strokebrush)) {
