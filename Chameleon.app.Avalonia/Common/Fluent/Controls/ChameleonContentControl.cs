...
public class ChameleonContentControl : HeaderedContentControl {
	...
	protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
	{
		...
		if(_expandOptionsButton is null)
			return;
	...
	{
		var isWindowChange = newSize.Width < 690; //ResponsiveConstants.MaxWindowWidth1080;

		_ = (_expandOptionsButton?.SetValue(IsVisibleProperty, isWindowChange));
