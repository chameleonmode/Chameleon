...
public class MboxService(IDispatchService dispatcher) : IMboxService {
	...
	public async Task<TaskDialogResult> ShowTaskDialog<TViewModel, Tview>(
		Func<TViewModel> initialize,
		string header, string? subHeader = null,
	...
	public async Task<TaskDialogResult> ShowTaskDialog<TViewModel>(
		Func<TViewModel> initialize,
		object content,
		string header,
