...
using Chameleon.Avalonia.FluentAvalonia.Services;
using Chameleon.Avalonia.FluentAvalonia.ViewModels;
using FluentAvalonia.Core;
using FluentAvalonia.UI.Controls;
using FluentAvalonia.UI.Media.Animation;
using FluentAvalonia.UI.Navigation;
using FluentAvalonia.UI.Windowing;
using static Chameleon.Avalonia.FluentAvalonia.MainWindow;

namespace Chameleon.Avalonia.FluentAvalonia.Views;
