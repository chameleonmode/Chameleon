...
public partial class SettingsViewModel(IApplicationUser user, IApplicationSettingsService settingsService)
			 : PageViewModelBase("Settings")
			 , ISettingsViewModel {
	private const string _system = "System";
	private const string _dark = "Dark";
	private const string _light = "Light";

	private readonly IApplicationUser _applicationUser = user;
	...
	private async Task InitializeLoginSucces()
	{
		...
		CurrentAppTheme = _settings.Settings.CurrentAppTheme ?? _system;
