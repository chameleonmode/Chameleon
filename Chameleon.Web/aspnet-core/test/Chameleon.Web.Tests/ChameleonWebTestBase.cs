...
{
    public abstract class ChameleonWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ChameleonWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ChameleonWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ChameleonDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ChameleonDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ChameleonDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ChameleonDbContext, Task<T>> func)
        {
            T result;
