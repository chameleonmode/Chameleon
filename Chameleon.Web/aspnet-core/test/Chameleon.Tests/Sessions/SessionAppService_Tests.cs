...
namespace Chameleon.Tests.Sessions
{
    public class SessionAppService_Tests : ChameleonTestBase
    {
        ...
        public async Task Should_Get_Current_User_When_Logged_In_As_Host()
        {
            ...
            // Act
            var output = await _sessionAppService.GetCurrentLoginInformationsAsync();
