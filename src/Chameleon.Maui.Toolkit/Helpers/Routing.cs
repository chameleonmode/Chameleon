...
public class PageViewModelRouting
{
    private PageViewModelRouting() { }                           
    private static PageViewModelRouting? instance = null;
    public static PageViewModelRouting Instance
    {
        get
        {
          return instance ??= new PageViewModelRouting();
        }
    }
    public Dictionary<Type, (Type GalleryPageType, Type ContentPageType)> ViewModelMappings { get; set; }
    ...
    public KeyValuePair<Type, (Type GalleryPageType, Type ContentPageType)> CreateViewModelMapping<TPage, TViewModel, TGalleryPage, TGalleryViewModel>() where TPage : BasePage<TViewModel>
