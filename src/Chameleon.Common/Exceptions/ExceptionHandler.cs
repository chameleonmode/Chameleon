...
namespace Chameleon.Common.Exceptions
{
    public class ExceptionHandler
    {
        ...
        private static Window _exceptionWindow;
        ...
        private static void LogError(Exception ex)
        {
            ...
            _logger.Log.Error(exception.Message, exception);
        }
        ...
        public static void ShowException(Exception exception, string message = null)
        {
            ...
            Application.Current.Dispatcher.Invoke(() => ShowExceptionWindow(exception));
        }
        ...
        private static Button CreateContinueButton(string content = "Continue")
        {
        ...
        private static Button CreateCopyButton(string message, string content = "Copy error")
        {
        ...
        private static Button CreateExitButton(string content = "Close application")
        {
            var button = new Button
            {
                Content = content,
        ...
        private static Button CreateReconnectButton(string content = "Reconnect")
        {
            var button = new Button
            {
                Content = content,
        ...
        private static void ShowWindow(string message, Button[] buttons, string title = "Unhandled exception", double width = 600d, double height = 400d)
        {
        ...
        private static void Continue_Click(object sender, RoutedEventArgs e)
        {
            _exceptionWindow.Hide();
            _exceptionWindow.Close();
        }

        private static void Reconnect_Click(object sender, RoutedEventArgs e)
        {
            _eventAggregator
