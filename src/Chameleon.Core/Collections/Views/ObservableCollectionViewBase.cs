using Chameleon.Core.Collections.MtObservableCollection;
using System;
...
using Chameleon.Core.Events;

namespace Chameleon.Core.Collections.Views;
...
public abstract class ObservableCollectionViewBase<TItem> : IList<TItem>, IDisposable, IList, INotifyCollectionChanged, INotifyPropertyChanged
{
    ...
    [Obsolete("Use methods on Items property instead.")]
