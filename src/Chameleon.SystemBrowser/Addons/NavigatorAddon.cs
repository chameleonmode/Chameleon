...
public static class NavigatorAddon
{
    public static async Task InitializeExtension(string dir)
    {
        ...
        await IOtil.WriteTextToFileAsync(
            Path.Combine(dir, "injector.js"), SetInjecto());
        await IOtil.WriteTextToFileAsync(
                    ...
                    return `(function() {{
                        const inject = (spoofContext) => {{
                            ...
                            if (injectionProperties.length > 0 || ${{this.spoof.custom !== ''}}) {{
                                spoofContext.Intl.DateTimeFormat = function(...args) {{
                                    ...
                                    if (CHAMELEON_SPOOF.has(spoofContext)) {{
                                        if (CHAMELEON_SPOOF.get(spoofContext).timezone) {{
                                            ...
                                            if (args.length === 2) {{
                                                if (!args[1].timeZone) args[1].timeZone = spoofData.zone.name;
                                            }} else if (args.length === 1) {{
                                                args.push({{ timeZone: spoofData.zone.name }});
                                            }} else {{
                                                args = [locale, {{ timeZone: spoofData.zone.name }}];
                                            }}
                                        }} else if (CHAMELEON_SPOOF.get(spoofContext).language) {{
                                            if (args.length === 0 || !args[0]) args[0] = locale;
                                        }}
                                    }}
                                ...
                                spoofContext.open = function(...args) {{
                                    let w = args.length ? _open.call(this, ...args) : _open.call(this);
                                    if (w) {{
                                        Object.defineProperty(w, 'Date', {{ value: spoofContext.Date }});
                                        Object.defineProperty(w.Intl, 'DateTimeFormat', {{ value: spoofContext.Intl.DateTimeFormat }});
                                        Object.defineProperty(w, 'screen', {{ value: spoofContext.screen }});
                                        Object.defineProperty(w, 'navigator', {{ value: spoofContext.navigator }});
                                        Object.defineProperty(w.Element.prototype, 'getBoundingClientRect', {{ value: spoofContext.Element.prototype.getBoundingClientRect }});
                                        Object.defineProperty(w.Element.prototype, 'getClientRects', {{ value: spoofContext.Element.prototype.getClientRects }});
                                        Object.defineProperty(w.Range.prototype, 'getBoundingClientRect', {{ value: spoofContext.Range.prototype.getBoundingClientRect }});
                                        Object.defineProperty(w.Range.prototype, 'getClientRects', {{ value: spoofContext.Range.prototype.getClientRects }});
                                    }}
                                    return w;
                                }};
                            ...
                            ((spoofContext, inject, fn) => {{
                                [""appendChild"", ""insertBefore"", ""replaceChild""].forEach(method => {{
                                    ...
                                    spoofContext.Node.prototype[method] = function(...args) {{
                                        let e = _original.apply(this, args);
                                        ...
                                        if (e && e.nodeName === 'LINK' && fn.CHAMELEON_SPOOF_f) fn.CHAMELEON_SPOOF_f();
                                        return e;
                                    }};
                                }});
                                ...
                                [""append"", ""insertAdjacentElement"", ""insertAdjacentHTML"", ""insertAdjacentText"", ""prepend"", ""replaceWith""].forEach(method => {{
                                    ...
                                    spoofContext.Element.prototype[method] = function(...args) {{
                                        let e = _original.apply(this, args);
                                        if (e && e.tagName === ""IFRAME"") {{
                                            try {{
                                                inject(e.contentWindow);                    
                                ...
                                ['innerHTML', 'outerHTML'].forEach(p => {{
                                    ...
                                    Object.defineProperty(spoofContext.Element.prototype, p, {{
                                        set(html) {{
                                            ...
                                            if (fn.modifyNodeFont) fn.modifyNodeFont(this.parentNode);
                                        }}
                                    }});
                                }});
                            }})(spoofContext, inject, {{
