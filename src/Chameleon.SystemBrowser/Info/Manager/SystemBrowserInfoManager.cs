...
public class SystemBrowserInfoManager : ISystemBrowserInfoManager
{
    ...
    private static bool TryGetSystemBrowserInfo(RegistryKey browserKey, out SystemBrowserInfo browser)
    {
    ...
    private static string GetBrowserPath(string browserPath)
    {
        browserPath = browserPath.TrimStart('\"');
        var extensionIndex = browserPath.LastIndexOf(".exe");
        return browserPath[..(extensionIndex + 4)];
    }
